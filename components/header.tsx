      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {isHomePage ? (
              <>
                <NavLink href="#accueil" onClick={() => handleNavClick("#accueil")}>
                  Accueil
                </NavLink>
                <NavLink href="#services" onClick={() => handleNavClick("#services")}>
                  Services
                </NavLink>
                <NavLink href="#equipe" onClick={() => handleNavClick("#equipe")}>
                  Équipe
                </NavLink>
                <NavLink href="#partenaires" onClick={() => handleNavClick("#partenaires")}>
                  Partenaires
                </NavLink>
            ...
            <nav className="flex flex-col space-y-4 p-4">
              {isHomePage ? (
                ...
                <>
                  ...
                  <NavLink href="/#equipe" onClick={() => setIsMenuOpen(false)}>
                    Équipe
                  </NavLink>
                  <NavLink href="/#partenaires" onClick={() => setIsMenuOpen(false)}>
                    Partenaires
                  </NavLink>
              ...
              <NavLink href="/blog" onClick={() => setIsMenuOpen(false)} className="flex items-center space-x-2">
                <BookOpen className="w-4 h-4" />
                <span>Blog</span>
              </NavLink>
              <NavLink
